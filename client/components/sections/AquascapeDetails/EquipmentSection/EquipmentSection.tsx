...
const EquipmentSection: React.FunctionComponent<Props> = ({
    ...
    const hasEquipment = [lights, filters, substrates, additives].some(equipment => !!equipment.length) || co2
...

                {
                    hasEquipment
                        ...
                        <Paragraph type="body" as="span">
                            <FormattedMessage id="aquascape.equipment.no_equipment" defaultMessage="No equipment added" />
                        </Paragraph>
                }
